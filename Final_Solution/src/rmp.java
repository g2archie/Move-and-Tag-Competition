...
//    }
        ...
        //System.out.println("mMatrix 256-257 is "+mMatrix[256][257]);
...
//    }
     ...
     /*   findPath(0,1);
        findPath(256,257);
        System.out.println("arraylength is "+ length);
        System.out.println("point 256 is "+getCoordinates(256)[0]);
        System.out.println("point 257 is "+getCoordinates(257)[0]);
        System.out.println("point 256 257 is "+isEdge(-11.274973674902682,-5.711817061105723,9.711426036714315,14.452909115856995));
        System.out.println("p1 p2 "+isBlocked(-11.274973674902682,-5.711817061105723,9.711426036714315,14.452909115856995));
        System.out.println("path 256 to 257 "+path[256][257]);
        System.out.println("point is" +findPoint(-11.274973674902682));
        System.out.println("point is" +findPoint(9.711426036714315));*/
